import type { DonHang, KiemTraMaGiamGiaRequest, KiemTraMaGiamGiaResponse, PhanTrang } from '../types';
...
export const donHangApi = {
  ...
  kiemTraMaGiamGia: (duLieu: KiemTraMaGiamGiaRequest) =>
    goiApi<KiemTraMaGiamGiaResponse>({ url: '/api/don-hang/kiem-tra-ma-giam-gia', method: 'POST', data: duLieu }),
